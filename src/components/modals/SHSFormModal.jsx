...
export default function SHSFormModal({
  ...
  const handleUpdate = async () => {
    ...
    try {
      await SeHighSchoolStudentService.updateStudent(
        selectedStudent.id,
        selectedStudent,
      );
    ...
    try {
      await SeHighSchoolStudentService.deleteStudent(selectedStudent.id);
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-gray-50/50 p-4 rounded-xl border border-gray-100">
                    <div className="flex flex-col md:col-span-3">
                      <label className={labelStyle}>
                        Last Elementary School Attended
                      </label>
                      <input
                        name="elschool_attended"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-gray-50/50 p-4 rounded-xl border border-gray-100">
                    <div className="flex flex-col md:col-span-3">
                      <label className={labelStyle}>
                        Last Junior High School Attended
                      </label>
                      <input
                        name="highschool_attended"
                        value={selectedStudent.highschool_attended || ""}
                        onChange={handleChange}
                        className={editableStyle}
