...
export default function ElementaryFormModal({
  ...
  const labelStyle =
    "font-['Inter'] ext-[10px] font-bold mb-1.5 ml-1 text-gray-400 uppercase tracking-tight";
        ...
        <div className="min-h-screen flex items-center justify-center py-12 px-4">
          <div className="bg-white w-full max-w-5xl rounded-3xl shadow-2xl relative p-6 md:p-10 border border-gray-100">
            ...
            <div className="bg-[#810100] text-white text-center py-5 rounded-2xl mb-10 shadow-md">
              <h1 className="text-2xl font-black uppercase tracking-widest font-['Inter']">
                buttonStudent Record
              </h1>
              <p className="text-red-100 text-[10px] mt-1 opacity-80 italic font-medium font-['Inter']">
                Update Information System
              </p>
            </div>

            <div className="space-y-10">
              <section className="bg-gray-50 p-6 rounded-2xl font-['Inter'] border border-gray-200">
              ...
              <section>
                ...
                <div className="font-['Inter'] grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-5">
                  <div className="flex flex-col">
