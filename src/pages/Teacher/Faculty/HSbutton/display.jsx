      ...
      <div className="flex-1 overflow-auto border border-gray-200 rounded-xl bg-[#faf9f6] shadow-inner h-180">
        ...
        {facultyList.length === 0 ? (
          ...
          facultyList.map((faculty) => (
            <div key={faculty.id} className="flex flex-col items-center text-center p-4 mt-10 border-2 border-transparent hover:border-[#edebdd] rounded-2xl transition-all">
              ...
              <p className="text-[#630000] text-lg font-medium">
