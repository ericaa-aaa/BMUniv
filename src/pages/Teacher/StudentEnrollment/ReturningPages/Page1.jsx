...
export default function EnrollmentForm() {
    ...
    const onSubmit = async (data) => {
        try {
            await RLStudentService.enrollStudent(data);
                ...
                <>
                    <div className="bg-[#EDEBDD] w-351 p-8 ml-12 rounded-2xl flex flex-col gap-6 mt-5">
                        <div className=" flex flex-row gap-8">
                            <p className="text-[#1B1717] text-[14px] mt-2">Elementary School Attended</p>
                                <input {...register("elschool_attended")} type="text" className="border text-[12px] w-30 h-10 p-3 rounded-[5px]" placeholder="School" required />
                                <p className="text-[#1B1717] text-[14px] mt-2">School Year</p>
                                <input {...register("school_year")} type="text" className="border text-[12px] w-30 h-10 p-3 rounded-[5px]" placeholder="Year" required />
                        </div>
                        <div className=" flex flex-row gap-8">
                            <p className="text-[#1B1717] text-[14px] mt-2">High School Attended</p>
                                <input {...register("highschool_attended")} type="text" className="border text-[12px] w-30 h-10 p-3 rounded-[5px]" placeholder="School" required />
                                <p className="text-[#1B1717] text-[14px] mt-2">School Year</p>
                                <input {...register("highschool_year")} type="text" className="border text-[12px] w-30 h-10 p-3 rounded-[5px]" placeholder="Year" required />
                        </div>
                        <div className=" flex flex-row gap-8">
                            <p className="text-[#1B1717] text-[14px] mt-2">Senior High School Attended</p>
                                <input {...register("Sehighschool_attended")} type="text" className="border text-[12px] w-30 h-10 p-3 rounded-[5px]" placeholder="School" required />
                                <p className="text-[#1B1717] text-[14px] mt-2">School Year</p>
                                <input {...register("Sehighschool_year")} type="text" className="border text-[12px] w-30 h-10 p-3 rounded-[5px]" placeholder="Year" required />
                                <p className="text-[#1B1717] text-[14px] mt-2">Semester</p>
                                <input {...register("sehigh_sem")} type="text" className="border text-[12px] w-30 h-10 p-3 rounded-[5px]" placeholder="Semester" required />
                        </div>
                    </div>
 
                    <div className="mt-136.5 ml-12 flex gap-4">
                        <button 
                            type="button" 
                            onClick={() => setStep(2)} 
                            className="flex items-center gap-2 px-8 py-4 bg-gray-500 text-white rounded-xl font-bold hover:bg-gray-600 transition-all shadow-md"
