            ...
            {step === 3 && (
                <>
                    <div className="bg-[#EDEBDD] w-275 p-8 ml-12 rounded-2xl flex flex-col gap-6 mt-5">
                        ...
                        <div className=" flex flex-row gap-6">
                            <p className="text-[#1B1717] text-[14px] w-32">High School Attended</p>
                                <input {...register("highschool_attended")} type="text" className="border text-[12px] w-50 h-10 p-3 rounded-[5px]" placeholder="School" required />
                                <p className="text-[#1B1717] text-[14px]">School Year</p>
                                <input {...register("highschool_year")} type="text" className="border text-[12px] w-50 h-10 p-3 rounded-[5px]" placeholder="Year" required />
                        </div>
                        <div className=" flex flex-row gap-6">
                            <p className="text-[#1B1717] text-[14px] w-32">Seniot High School Attended</p>
                                <input {...register("Sehighschool_attended")} type="text" className="border text-[12px] w-50 h-10 p-3 rounded-[5px]" placeholder="School" required />
                                <p className="text-[#1B1717] text-[14px]">School Year</p>
                                <input {...register("Sehighschool_year")} type="text" className="border text-[12px] w-50 h-10 p-3 rounded-[5px]" placeholder="Year" required />
                                <p className="text-[#1B1717] text-[14px]">Semester</p>
                                <input {...register("sehigh_sem")} type="text" className="border text-[12px] w-50 h-10 p-3 rounded-[5px]" placeholder="Semester" required />
                        </div>
                    </div>
