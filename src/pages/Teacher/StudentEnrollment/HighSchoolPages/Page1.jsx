      ...
      {step === 1 && (
        <>
          ...
          <div className="grid grid-cols-5 gap-y-5 justify-items-center max-w-7xl mx-auto ">
            ...
            <div className="flex flex-col gap-1 col-span-2 ml-9">
              <p className="text-[#1B1717] text-[14px]">Place of Birth:</p>
              <input
                {...register("place_of_birth", { required: true })}
                type="text"
                className={`border border-[#630000] shadow-sm text-[13px] tracking-wider h-10 p-3 rounded-[5px] w-114 ${errors.place_of_birth ? "border-red-500 bg-red-50" : "border-#630000"}`}
          ...
          <div className="grid grid-cols-5 gap-y-5 justify-items-center max-w-7xl mx-auto mt-3">
            <div className="flex flex-col gap-1 col-span-1 ml-9">
              ...
              <input
                ...
                type="tel"
                maxLength={11}
                className={`border border-[#630000] shadow-sm text-[12px] w-50 h-10 p-3 rounded-[5px] ${errors.contact_number ? "border-red-500 bg-red-50" : "border-#630000"}`}
      ...
      {step === 3 && (
        <>
          ...
          <div className="flex gap-5 mt-6 pl-43">
            <p className="text-[#1B1717] text-[14px]">
              Is this student a returning learners?{" "}
              <span className="text-[#630000]">(✓) if yes</span>
            </p>
            <input
              {...register("is_RL")}
          ...
          <div className="grid grid-cols-5 gap-y-5 justify-items-center max-w-7xl mx-auto mt-3">
            <div className="flex flex-col gap-1 ml-9">
              <p className="text-[#1B1717] text-[14px] mt-3 ">
          ...
          <div className="flex gap-5 pl-43 mt-6">
            <p className="text-[#1B1717] text-[14px]">
              Is this student a scholarship recipient?{" "}
              <span className="text-[#630000]">(✓) if yes</span>
            </p>
            <input
              {...register("schorecipient")}
              type="checkbox"
              className="w-5 h-5 accent-[#630000]"
            />
          </div>
