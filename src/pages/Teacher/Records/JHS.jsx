...
export default function JHS() {
  const [students, setStudents] = useState([
    ...
    { id: 2, name: "Reyes, Anna L.", grade: "10", section: "LOYALTY", status: "Enrolled", image: "jpg" },
    { id: 3, name: "Santos, Carlo M.", grade: "9", section: "PERSEVERANCE", status: "Enrolled", image: "png" },
    { id: 4, name: "Santos, Carlo M.", grade: "8", section: "COMPASSION", status: "Enrolled", image: "png" },
    { id: 5, name: "Santos, Carlo M.", grade: "7", section: "LOYALTY", status: "Enrolled", image: "png" },
    { id: 6, name: "Santos, Carlo M.", grade: "9", section: "PERSEVERANCE", status: "Enrolled", image: "png" },
    { id: 7, name: "Santos, Carlo M.", grade: "8", section: "COMPASSION", status: "Enrolled", image: "png" },
    { id: 8, name: "Santos, Carlo M.", grade: "7", section: "LOYALTY", status: "Enrolled", image: "png" },
    { id: 9, name: "Santos, Carlo M.", grade: "8", section: "PERSEVERANCE", status: "Enrolled", image: "png" },
    { id: 10, name: "Santos, Carlo M.", grade: "8", section: "COMPASSION", status: "Enrolled", image: "png" },
    { id: 11, name: "Santos, Carlo M.", grade: "9", section: "LOYALTY", status: "Enrolled", image: "png" },
    { id: 12, name: "Santos, Carlo M.", grade: "9", section: "PERSEVERANCE", status: "Enrolled", image: "png" },
    { id: 13, name: "Santos, Carlo M.", grade: "9", section: "COMPASSION", status: "Enrolled", image: "png" },
    { id: 14, name: "Santos, Carlo M.", grade: "9", section: "LOYALTY", status: "Enrolled", image: "png" },
    { id: 15, name: "Santos, Carlo M.", grade: "9", section: "PERSEVERANCE", status: "Enrolled", image: "png" },
    { id: 16, name: "Santos, Carlo M.", grade: "10", section: "COMPASSION", status: "Enrolled", image: "png" },
    { id: 17, name: "Santos, Carlo M.", grade: "10", section: "LOYALTY", status: "Enrolled", image: "png" },
  ]);
      ...
      <div className="absolute inset-0 bg-white/80 px-6 py-8 flex flex-col">
        ...
        <div className="flex justify-center mb-8 shrink-0">
          <h1 className="bg-[#8B0000] text-white px-12 py-3 rounded-2xl text-lg md:text-xl font-semibold shadow-lg">
            Junior High School Students Records
          </h1>
        </div>
