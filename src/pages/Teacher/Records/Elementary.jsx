...
export default function Elementary() {
  const [students, setStudents] = useState([
    ...
    { id: 2, name: "Reyes, Anna L.", grade: "2", section: "Gumamela", status: "Enrolled", image: "jpg" },
    { id: 3, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 4, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 5, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 6, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 7, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 8, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 9, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 10, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 11, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 12, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 13, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 14, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 15, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 16, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
    { id: 17, name: "Santos, Carlo M.", grade: "6", section: "Daisy", status: "Enrolled", image: "png" },
  ]);
