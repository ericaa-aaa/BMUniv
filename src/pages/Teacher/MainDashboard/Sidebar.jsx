      ...
      <nav className="flex flex-col gap-6 font-['Inter'] font-medium">
        <div>
          <div
            ...
            className="group flex items-center gap-3 cursor-pointer py-2 px-7 rounded mb-6 relative hover:bg-[#EDEBDD]"
          >
            <svg
              ...
              fill="none"
              stroke="currentcolor"
              strokeWidth={`${activeItem === "dashboard" ? "3" : "2 "}`}
              strokeLinecap="round"
            ...
            ${activeItem === "dashboard" ? "font-extrabold" : "font-normal"}`}
            >
              Dashboard
            </Link>
          </div>
          ...
          >
            <div className="flex items-center gap-3 cursor-pointer">
              <svg
                ...
                fill="none"
                stroke="#EDEBDD"
                strokeWidth={`${openEnrollment ? "3" : "2"}`}
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              <a
                className={`whitespace-nowrap transition-colors duration-300 text-[#EDEBDD] group-hover:text-[#1B1717] ${
                  openEnrollment ? "font-extrabold" : "font-normal"
                }`}
              >
                Student Enrollment{" "}
              </a>
          ...
          {openEnrollment && (
            <div className="ml-6 mt-2 flex flex-col gap-2 text-sm">
              <div
                onClick={() => setActiveItem("elementary")}
                className={`flex items-center gap-3 cursor-pointer rounded transition`}
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${
                    activeItem === "elementary"
                      ? "bg-[#EDEBDD]"
                      : "bg-[#1B1717]"
                  }`}
                ></span>
              ...
              <div
                onClick={() => setActiveItem("highschool")}
                className={`flex items-center gap-3 cursor-pointer rounded transition`}
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${
                    activeItem === "highschool"
                      ? "bg-[#EDEBDD] "
                      : "bg-[#1B1717]"
                  }`}
                ></span>
              ...
              <div
                onClick={() => setActiveItem("seniorhighschool")}
                className={`flex items-center gap-3 cursor-pointer rounded transition`}
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${
                    activeItem === "seniorhighschool"
                      ? "bg-[#EDEBDD]"
                      : "bg-[#1B1717]"
                  }`}
                ></span>
       ...
       <div>
        ...
        <div>
          ...
          >
            <div className="flex items-center gap-3 cursor-pointer">
              ...
              <a
                className={`whitespace-nowrap transition-colors duration-300 text-[#EDEBDD] group-hover:text-[#1B1717] ${
                  openRecords ? "font-extrabold" : "font-normal"
                }`}
              >
                Student Records
              </a>
          ...
          {openRecords && (
            <div className="ml-6 mt-2 flex flex-col gap-2 text-sm">
              ...
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${activeItem === "elementary" ? "bg-[#EDEBDD]" : "bg-[#1B1717]"}`}
                ></span>
                <Link
                  to="/teacher/elemrec"
                  className={`cursor-pointer ${activeItem === "elementary" ? "underline" : "hover:underline"}`}
                >
                  Elementary Records
                </Link>
              </div>
              <div
                onClick={() => setActiveItem("jhs")}
                className="flex items-center gap-3 cursor-pointer rounded transition"
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${activeItem === "jhs" ? "bg-[#EDEBDD]" : "bg-[#1B1717]"}`}
                ></span>
                <Link
                  to="/teacher/jhsrec"
                  className={`cursor-pointer ${activeItem === "jhs" ? "underline" : "hover:underline"}`}
                >
                  Junior High School Records
                </Link>
              </div>
              <div
                onClick={() => setActiveItem("shs")}
                className="flex items-center gap-3 cursor-pointer rounded transition"
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${activeItem === "shs" ? "bg-[#EDEBDD]" : "bg-[#1B1717]"}`}
                ></span>
                <Link
                  to="/teacher/shsrec"
                  className={`cursor-pointer ${activeItem === "shs" ? "underline" : "hover:underline"}`}
                >
                  Senior High School Records
                </Link>
              </div>
        ...
        <div>
          ...
          >
            ...
            <a
              className={`whitespace-nowrap transition-colors duration-300 text-[#EDEBDD] group-hover:text-[#1B1717] ${
                openFaculty ? "font-extrabold" : "font-normal"
              }`}
            >
              Faculty
            </a>
          ...
          {openFaculty && (
            <div className="ml-6 mt-2 flex flex-col gap-2 text-sm">
              <div
                onClick={() => setActiveItem("elementary-faculty")}
                className={`flex items-center gap-3 cursor-pointer rounded transition`}
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${
                    activeItem === "elementary-faculty"
                      ? "bg-[#EDEBDD]"
                      : "bg-[#1B1717] "
                  }`}
                ></span>
                <Link
                  to="/teacher/elemfaculty"
                  className={`cursor-pointer ${
                    activeItem === "elementary-faculty"
                      ? "underline"
                      : "hover:underline"
              ...
              <div
                onClick={() => setActiveItem("hsfaculty")}
                className={`flex items-center gap-3 cursor-pointer rounded transition`}
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${
                    activeItem === "hsfaculty"
                      ? "bg-[#EDEBDD] "
                      : "bg-[#1B1717]"
                  }`}
                ></span>
                <Link
                  to="/teacher/hsfaculty"
                  className={`cursor-pointer ${
              ...
              <div
                onClick={() => setActiveItem("shsfaculty")}
                className={`flex items-center gap-3 cursor-pointer rounded transition`}
              >
                <span
                  className={`w-3 h-3 rounded-full border-2 ${
                    activeItem === "shsfaculty"
                      ? "bg-[#EDEBDD]"
                      : "bg-[#1B1717]"
                  }`}
                ></span>
                <Link
                  to="/teacher/shsfaculty"
                  className={`cursor-pointer ${
                    activeItem === "shsfaculty"
                      ? "underline"
                      : "hover:underline"
