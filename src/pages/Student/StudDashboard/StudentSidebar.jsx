    ...
    <div className="w-67 bg-[#630000] text-[#EDEBDD] flex flex-col p-6 min-h-screen pr-5">
      ...
      <nav className="flex flex-col gap-6 font-['Inter'] font-medium">
        ...
        <div>
          <div onClick={() => { setOpenSubjects(!openSubjects); }} 
            ...
            <Link to="/student/studsubj"  
              className={`transition-colors duration-300 ${openSubjects === "subjects" ? 'text-[#1B1717] font-extrabold' : 'text-[#EDEBDD] group-hover:text-[#1B1717] font-normal'}`}>
              Student Subjects
            </Link>
          </div>
        </div>
      ...
      <div className="mt-auto">
        <button 
          ...
          className="flex items-center gap-2 cursor-pointer text-[#EDEBDD] hover:text-white transition-all group"
        >
          <svg 
